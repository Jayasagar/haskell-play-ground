...
/* package haskell-play-ground-0.1.0.0 */
#define VERSION_haskell_play_ground "0.1.0.0"
#define MIN_VERSION_haskell_play_ground(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "haskell-play-ground-0.1.0.0-BPk6xL8islHMtQLoa91Cu"

#define CURRENT_PACKAGE_KEY "haskell-play-ground-0.1.0.0-BPk6xL8islHMtQLoa91Cu"
